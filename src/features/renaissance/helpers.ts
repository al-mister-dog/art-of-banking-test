...
function exchangeBill(holder: any, recipient: Party, presentedBill: any) {
...
function exchangeMoney(payee: any, drawee: any, bill: any) {
  ...
  if (cityQuotesCertain) {
    ...
    payee.coinAsset = [
      ...payee.coinAsset,
      { coinType: currencies[drawee.city], amount: unitOfAccount },
    ];
    drawee.coinLiability = [
      ...drawee.coinLiability,
      { coinType: currencies[drawee.city], amount: unitOfAccount },
    ];
  } else {
    ...
    payee.coinAsset = [
      ...payee.coinAsset,
      { coinType: currencies[drawee.city], amount: localCurrency },
    ];
    drawee.coinLiability = [
      ...drawee.coinLiability,
      { coinType: currencies[drawee.city], amount: localCurrency },

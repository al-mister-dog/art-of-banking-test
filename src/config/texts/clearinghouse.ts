export const clearinghouseText = {
  ...
  step5: {
    ...
    Then settle dues and see what happens to the banks' certificate accounts. If you get lost following the
    trail just hit the refresh button in the settings panel and start over.`,
  },
  step6: {
    lectureTitle: `Clearing House`,
